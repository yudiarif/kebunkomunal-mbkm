                    ...
                    <div class="col-sm-12 col-xl-12">
                        <div class=" h-100 p-4">
                            ...
                            <form>
                                ...
                                <div class="row mb-3">
                                    <label for="signed_url" class="col-sm-4 col-form-label">Token Url</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="signed_url" value="{{ $user->signed_url }}" name="signed_url" readonly>
                                    </div>
                                </div>
                                <div class="row mb-3">
