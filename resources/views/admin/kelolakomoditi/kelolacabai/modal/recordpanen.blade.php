        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Panen cabai</h5>
                            ...
                            <table class="table" style="width:100%">
                                ...
                                <tbody>
                                  @php
                                      $no=1
                                  @endphp
                                  @foreach ($datapanencabai as $panencabai)
                                  <tr class="text-center">
                                      <td>{{ $no }}</td>
                                      <td>
                                              @if ($panencabai->tanggal_panen)
                                                  @php
                                      ...
                                      <td class="text-center">
                                        {{ $panencabai->jumlah_panen }} kg
                                      </td>
                                      <td class="text-center">
                                        <a class="btn btn-sm btn-danger my-1" data-bs-toggle="modal" data-bs-target="#modalDeletePanen{{ $panencabai->id }}" href="">Hapus</a>
                                        @include('admin.kelolakomoditi.kelolacabai.modal.deletepanen')
                                      </td>
                                  </tr>
                                  @php
                                      $no++
