        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Kelola Foto Perkembangan cabai</h5>
                    ...
                    <div class=" h-100 p-4">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <input type="file" class="form-control mb-2" id="foto1" name="foto1">
                                @if(($fotocabai))
                                <img src="{{ asset('storage/' . $fotocabai->foto1 ) }}" alt="Belum Ada Foto" style="max-width: 200px;" class="mb-2">
                                @else
                                <p>Belum Ada Foto</p>
                                @endif
                                <input type="file" class="form-control mb-2" id="foto2" name="foto2">
                                @if(($fotocabai))
                                <img src="{{ asset('storage/' . $fotocabai->foto2 ) }}" alt="Belum Ada Foto" style="max-width: 200px;" class="mb-2">
                                @else
                                <p>Belum Ada Foto</p>
                                @endif
                                <input type="file" class="form-control mb-2" id="foto3" name="foto3">
                                @if(($fotocabai))
                                <img src="{{ asset('storage/' . $fotocabai->foto3 ) }}" alt="Belum Ada Foto" style="max-width: 200px;" class="mb-2">
                                @else
                                <p>Belum Ada Foto</p>
                                @endif
                            </div>
