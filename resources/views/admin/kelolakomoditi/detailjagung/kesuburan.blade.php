    ...
    <div class="bg-light rounded h-100 p-4">
        <h6 class="mb-4">Kesuburan Tanah</h6>
            <div class="testimonial-item text-center mt-3">
                ...
                <div class="ph-progress mx-auto" data-value='{{ optional($users->komoditiInfoJagung->last())->ph_tanah }}'>
                    ...
                    <div class="ph-progress-value w-100 h-100 rounded-circle d-flex align-items-center justify-content-center">
                        <div class="font-weight-bold mt-3">
                            <h1 class="ph-value">{{ optional($users->komoditiInfoJagung->last())->ph_tanah }}</h1>
                        </div>
                    </div>
                </div>
                <div class="row text-center mt-4">
                    <div class="col-12">
                        ...
                        <span class="small text-gray">Ideal untuk jagung</span>
                    </div>
                </div>
            </div>
        <!-- </div> -->
