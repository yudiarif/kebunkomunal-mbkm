                            ...
                            <table class="table" style="width:100%">
                                ...
                                <tbody>
                                  @php
                                      $no=1
                                  @endphp
                                  @foreach ($datapanennila as $panennila)
                                  <tr class="text-center">
                                      <td>{{ $no }}</td>
                                      <td>
                                              @if ($panennila->tanggal_panen)
                                                  @php
                                      ...
                                      <td class="text-center">
                                        {{ $panennila->jumlah_panen }} kg
                                      </td>
                                      <td class="text-center">
                                        <a class="btn btn-sm btn-danger my-1" data-bs-toggle="modal" data-bs-target="#modalDeletePanen{{ $panennila->id }}" href="">Hapus</a>
                                        @include('admin.kelolakomoditi.kelolanila.modal.deletepanen')
                                      </td>
                                  </tr>
                                  @php
                                      $no++
