    ...
    <div class="row w-auto h-100 mx-0">
        ...
        <div class="container-fluid pt-4 px-1">
          <div class=" align-items-center justify-content-between mb-4">
                  <h5 class="mb-0">Komoditi Nila {{ $namauser->nama }}
              </div>
              <div class="p-2">
                <div class="d-flex row align-items-center justify-content-between mb-4">
                    <div class="col-lg-12 align-items-center justify-content-between text-center">
                        ...
                        @include('admin.kelolakomoditi.kelolanila.modal.recordpanen')
                      ...
                      <table id="example" class="table table-striped" style="width:100%">
                          ...
                          <tbody>
                            @php
                                $no=1
                            @endphp
                            @foreach ($datanila as $nila)
                            <tr class="text-center">
                                <td>{{ $no }}</td>
                                <td>
                                    <a href="http://" data-bs-toggle="modal" data-bs-target="#modalDetail{{ $nila->id }}">
                                        @if ($nila->created_at)
                                            @php
                                ...
                                <td class="text-center">
                                    <a class="btn btn-sm btn-primary my-1" data-bs-toggle="modal" data-bs-target="#modalEdit{{ $nila->id }}" href="">Edit</a>
                                    <a class="btn btn-sm btn-danger my-1" data-bs-toggle="modal" data-bs-target="#modalDelete{{ $nila->id }}" href="">Hapus</a>
                        
                                    @include('admin.kelolakomoditi.kelolanila.modal.edit')
                                    @include('admin.kelolakomoditi.kelolanila.modal.detail')
                                    @include('admin.kelolakomoditi.kelolanila.modal.delete')
