        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Kelola Foto Panorama Jagung</h5>
                    ...
                    <div class=" h-100 p-4">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                ...
                                @if(($panoramajagung))
                                <img src="{{ asset('storage/' . $panoramajagung->panorama1 ) }}" alt="Belum Ada panorama" style="max-width: 200px;" class="mb-2">
                                @else
                                <p>Belum Ada panorama</p>
                                @endif
                                <input type="file" class="form-control mb-2" id="panorama2" name="panorama2">
                                @if(($panoramajagung))
                                <img src="{{ asset('storage/' . $panoramajagung->panorama2 ) }}" alt="Belum Ada panorama" style="max-width: 200px;" class="mb-2">
                                @else
                                <p>Belum Ada panorama</p>
                                @endif
                                <input type="file" class="form-control mb-2" id="panorama3" name="panorama3">
                                @if(($panoramajagung))
                                <img src="{{ asset('storage/' . $panoramajagung->panorama3 ) }}" alt="Belum Ada panorama" style="max-width: 200px;" class="mb-2">
                                @else
                                <p>Belum Ada panorama</p>
                                @endif
                            </div>
