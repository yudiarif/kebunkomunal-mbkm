        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Panen Jagung</h5>
                            ...
                            <table class="table" style="width:100%">
                                ...
                                <tbody>
                                  @php
                                      $no=1
                                  @endphp
                                  @foreach ($datapanenjagung as $panenjagung)
                                  <tr class="text-center">
                                      <td>{{ $no }}</td>
                                      <td>
                                              @if ($panenjagung->tanggal_panen)
                                                  @php
