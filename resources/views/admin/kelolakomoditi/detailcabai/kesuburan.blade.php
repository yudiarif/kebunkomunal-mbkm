    ...
    <div class="bg-light rounded h-100 p-4">
        <h6 class="mb-4">Kesuburan Tanah</h6>
            ...
            <!-- <div class="testimonial-item text-center mt-3">
                <h2 class="h5 font-weight-bold text-center mb-4"><i class="fa fa-temperature-low me-3"></i>Kelembapan Tanah</h2>
                <div class="progressc mx-auto" data-value='40'>
                    ...
                    <div class="progressc-value w-100 h-100 rounded-circle d-flex align-items-center justify-content-center">
                        <div class="font-weight-bold mt-3">
                            <h1 style="color: #3c89d0;">40<sup class="small">%</sup></h1>
                        </div>
                    </div>
                </div>
                <div class="row text-center mt-4">
                    <div class="col-12">
                        <div class="h2 font-weight-bold mb-0" style="color: #3c89d0;">30-60%</div><span class="small text-gray">Ideal untuk cabai</span>
                    </div>
                </div>
            </div> -->
            <div class="testimonial-item text-center mt-3">
                <h2 class="h5 font-weight-bold text-center mb-4"><i class="fa fa-vial me-3"></i>PH Tanah</h2>
                <div class="ph-progress mx-auto" data-value='{{ optional($users->KomoditiInfoCabai->last())->ph_tanah }}'>
                    ...
                    <div class="ph-progress-value w-100 h-100 rounded-circle d-flex align-items-center justify-content-center">
                        <div class="font-weight-bold mt-3">
                            <h1 class="ph-value">{{ optional($users->KomoditiInfoCabai->last())->ph_tanah }}</h1>
                        </div>
                    </div>
                </div>
                <div class="row text-center mt-4">
