<div class="col-sm-12 col-xl-6">
    <div class="bg-light rounded h-100 p-4">
                        ...
                        <div class="bg-light rounded d-flex justify-content-center p-4">
                            ...
                            <div class="ms-3" style="text-align: center;">
                                ...
                                <h2 class="mb-0" style="color: green;">
                                    @if (!optional($users->KomoditiInfoCabai->last())->tinggi == NULL)
                                        
                                    {{ optional($users->KomoditiInfoCabai->last())->tinggi }}
                                    @else
                                        -
                                    @endif
                                </h2>
                    ...
                    <div class="bg-light rounded d-flex justify-content-center p-4">
                        ...
                        <div class="ms-3" style="text-align: center;">
                            ...
                            <h2 class="mb-0" style="color: red;">
                                @if (!($users->KomoditiInfoCabai)->sum('kematian')==NULL)
                                    
                                {{ ($users->KomoditiInfoCabai)->sum('kematian') }}
                                @else
                                    -
                                @endif
                            </h2>
        ...
        <div class="custom-progress mt-3">
            <div class="progress-bar progress-bar-0-25" style="width: 20%;" aria-valuenow="{{ optional($users->KomoditiInfoCabai->last())->kehijauan }}" aria-valuemin="0" aria-valuemax="100">
                <div style="font-size: large;">{{ optional($users->KomoditiInfoCabai->last())->kehijauan }}</div>
            </div>
        </div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <canvas id="pertumbuhancabai"></canvas>
            </div>
...
<div class="modal fade" id="kematianModal" tabindex="-1" role="dialog" aria-labelledby="pertumbuhanModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <canvas id="kematiancabai"></canvas>
            </div>
            <!-- Tambahan jika diperlukan: Tombol Simpan, Tombol Tutup, dll. -->
        </div>
    </div>
...
<script>
     // pertumbuhan
     var ctxPertumbuhan = $("#pertumbuhancabai").get(0).getContext("2d");
     ...
     var mingguCabai = @json($users->KomoditiInfoCabai->pluck('tinggi')->toArray());
     var tinggiCabai = @json($users->KomoditiInfoCabai->pluck('tinggi'));
     var kematianCabai = @json($users->KomoditiInfoCabai->pluck('kematian'));

     var labels = [];
    for (var i = 1; i <= mingguCabai.length; i++) {
     ...
     // kematian
     var ctxKematian = $("#kematiancabai").get(0).getContext("2d");
