        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Kelola Foto Panorama Panorama</h5>
                    ...
                    <div class=" h-100 p-4">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                ...
                                @if(($panoramaayam))
                                <img src="{{ asset('storage/' . $panoramaayam->panorama1 ) }}" alt="Belum Ada panorama" style="max-width: 200px;" class="mb-2">
                                @else
