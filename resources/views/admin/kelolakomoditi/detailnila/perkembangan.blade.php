                        ...
                        <div class="bg-light rounded d-flex justify-content-center p-4">
                            ...
                            <div class="ms-3" style="text-align: center;">
                                ...
                                <h2 class="mb-0" style="color: green;">
                                    @if (!optional($users->KomoditiInfoNila->last())->berat == NULL )
                                    {{ optional($users->KomoditiInfoNila->last())->berat }}
                                    @else
                                        -
                                    @endif
                                </h2>
                        ...
                        <div class="bg-light rounded d-flex justify-content-center p-4">
                            ...
                            <div class="ms-3" style="text-align: center;">
                                ...
                                <h2 class="mb-0" style="color: red;">
                                    @if (!($users->KomoditiInfoNila)->sum('kematian') == NULL)
                                    
                                    {{ ($users->KomoditiInfoNila)->sum('kematian') }}
                                    @else
                                        -
                                    @endif
                                </h2>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title" id="pertumbuhanModalLabel">Pertumbuhan Nila</h6>
...
<div class="modal fade" id="kematianModal" tabindex="-1" role="dialog" aria-labelledby="pertumbuhanModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title" id="pertumbuhanModalLabel">Kematian Nila</h6>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<script>
     ...
     var mingguNila = @json($users->KomoditiInfoNila->pluck('berat')->toArray());
     var beratNila = @json($users->KomoditiInfoNila->pluck('berat'));
     var kematianNila = @json($users->KomoditiInfoNila->pluck('kematian'));

     var labels = [];
    for (var i = 1; i <= mingguNila.length; i++) {
