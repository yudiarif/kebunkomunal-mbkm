    ...
    <div class="bg-light rounded h-100 p-4">
        ...
        <div class="owl-carousel testimonial-carousel">
            ...
            <div class="testimonial-item text-center mt-3">
                ...
                <div class="progressc mx-auto" data-value='{{ optional($datanila->last())->oksigen }}'>
                    ...
                    <div class="progressc-value w-100 h-100 rounded-circle d-flex align-items-center justify-content-center">
                        <div class="font-weight-bold mt-3">
                            <h2 style="color: #3c89d0;">{{ optional($datanila->last())->oksigen }}<sup class="small">mg</sup></h2>
                        </div>
                    </div>
                </div>
            ...
            <div class="testimonial-item text-center mt-3">
                ...
                <div class="ph-progress mx-auto" data-value='{{ optional($datanila->last())->ph }}'>
                    ...
                    <div class="ph-progress-value w-100 h-100 rounded-circle d-flex align-items-center justify-content-center">
                        <div class="font-weight-bold mt-3">
                            <h1 class="ph-value">{{ optional($datanila->last())->ph }}</h1>
                        </div>
                    </div>
                </div>
                <div class="row text-center mt-4">
            ...
            <div class="testimonial-item text-center mt-3">
                ...
                <div class="progressa mx-auto" data-value='{{ optional($datanila->last())->amoniac }}'>
                    ...
                    <div class="progressa-value w-100 h-100 rounded-circle d-flex align-items-center justify-content-center">
                        <div class="font-weight-bold mt-3">
                            <h2 style="color: #790FFB;">{{ optional($datanila->last())->amoniac }}<sup class="small">mg</sup></h2>
                        </div>
                    </div>
                </div>
                <div class="row text-center mt-4">
