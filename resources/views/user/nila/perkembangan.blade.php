                    ...
                    <a href="#" data-toggle="modal" data-target="#pertumbuhanModal">
                        <div class="bg-light rounded d-flex justify-content-center p-4">
                            ...
                            <div class="ms-3" style="text-align: center;">
                                ...
                                <h2 class="mb-0" style="color: green;">{{ optional($datanila->last())->berat }}</h2>
                                <h7>Kilogram</h7>
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="#" data-toggle="modal" data-target="#kematianModal">
                        <div class="bg-light rounded d-flex justify-content-center p-4">
                            ...
                            <div class="ms-3" style="text-align: center;">
                                ...
                                <h2 class="mb-0" style="color: red;">{{ optional($datanila)->sum('kematian') }}</h2>
...
<script>
     ...
     var mingguNila = @json($datanila->pluck('berat')->toArray());
     var beratNila = @json($datanila->pluck('berat'));
     var kematianNila = @json($datanila->pluck('kematian'));
