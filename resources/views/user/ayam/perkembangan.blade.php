                        ...
                        <div class="bg-light rounded d-flex justify-content-center p-4">
                            ...
                            <div class="ms-3" style="text-align: center;">
                                ...
                                <h2 class="mb-0" style="color: green;">
                                    @if (!optional($dataayam->last())->berat == NULL)
                                    {{ optional($dataayam->last())->berat }}
                        ...
                        <div class="bg-light rounded d-flex justify-content-center p-4">
                            ...
                            <div class="ms-3" style="text-align: center;">
                                ...
                                <h2 class="mb-0" style="color: red;">
                                    @if (!optional($dataayam)->sum('kematian') == NULL)
                                        
                                    {{ optional($dataayam)->sum('kematian') }}
                                    @else
                                        -
                                    @endif
                                </h2>
...
<script>
     ...
     var mingguAyam = @json($dataayam->pluck('berat')->toArray());
     var beratAyam = @json($dataayam->pluck('berat'));
     var kematianAyam = @json($dataayam->pluck('kematian'));
