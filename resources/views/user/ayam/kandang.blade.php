    ...
    <div class="bg-light rounded h-100 p-4">
        ...
        <div class="owl-carousel testimonial-carousel">
            ...
            <div class="testimonial-item text-center mt-3">
                ...
                <div class="progressc mx-auto" data-value='{{ optional($dataayam->last())->suhu }}'>
                    ...
                    <div class="progressc-value w-100 h-100 rounded-circle d-flex align-items-center justify-content-center">
                        <div class="font-weight-bold mt-3">
                            <h2 style="color: #3c89d0;">
                                {{ optional($dataayam->last())->suhu }}<sup class="small">&deg;C</sup></h2>
                        </div>
                    </div>
                </div>
            ...
            <div class="testimonial-item text-center mt-3">
                ...
                <div class="progressa mx-auto" data-value='{{ optional($dataayam->last())->amoniac }}'>
                    ...
                    <div class="progressa-value w-100 h-100 rounded-circle d-flex align-items-center justify-content-center">
                        <div class="font-weight-bold mt-3">
                            <h2 style="color: #790FFB;">{{ optional($dataayam->last())->amoniac }}<sup class="small">ppm</sup></h2>
                        </div>
                    </div>
                </div>
                <div class="row text-center mt-4">
