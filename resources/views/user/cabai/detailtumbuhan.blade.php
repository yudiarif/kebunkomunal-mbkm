    ...
    <div class="row g-4">
        <div class="col-sm-12 col-xl-6">
            <div class="bg-light rounded h-100 p-4">
                ...
                @if ($dataperkembangan)
                <a href="{{ asset('storage/' . $dataperkembangan->foto1) }}" data-fancybox="cabai" data-caption="{{ $dataperkembangan->created_at }}">
                    <img src="{{ asset('storage/' . $dataperkembangan->foto1) }}" style="border-radius: 15px; width: 100%;" alt="" class="zoomable-image">
                </a>
                <a href="{{ asset('storage/' . $dataperkembangan->foto2 ) }}" data-fancybox="cabai" data-caption="{{ $dataperkembangan->created_at }}"></a>
                <a href="{{ asset('storage/' . $dataperkembangan->foto3 ) }}" data-fancybox="cabai" data-caption="{{ $dataperkembangan->created_at }}"></a>
                @else
                <h4>
