<div class="col-sm-12 col-xl-6">
    <div class="bg-light rounded h-100 p-4">
                        ...
                        <div class="bg-light rounded d-flex justify-content-center p-4">
                            ...
                            <div class="ms-3" style="text-align: center;">
                                ...
                                <h2 class="mb-0" style="color: green;">
                                    @if (!optional($datacabai->last())->tinggi == NULL)
                                        
                                    {{ optional($datacabai->last())->tinggi }}
                                    @else
                                        -
                                    @endif
                                </h2>
                    ...
                    <div class="bg-light rounded d-flex justify-content-center p-4">
                        ...
                        <div class="ms-3" style="text-align: center;">
                            ...
                            <h2 class="mb-0" style="color: red;">
                                @if (!optional($datacabai)->sum('kematian') == NULL)
                                {{ optional($datacabai)->sum('kematian') }}
                                @else
                                    -
                                @endif
                            </h2>
        ...
        <div class="custom-progress mt-3">
            <div class="progress-bar progress-bar-0-25" style="width: 20%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">
                <div style="font-size: large;">{{ optional($datacabai->last())->kehijauan }}</div>
            </div>
        </div>
...
<script>
     ...
     var mingguCabai = @json($datacabai->pluck('tinggi')->toArray());
     var tinggiCabai = @json($datacabai->pluck('tinggi'));
     var kematianCabai = @json($datacabai->pluck('kematian'));
