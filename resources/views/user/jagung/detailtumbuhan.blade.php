    ...
    <div class="row g-4">
        <div class="col-sm-12 col-xl-6">
            <div class="bg-light rounded h-100 p-4">
                ...
                <a href="{{ asset('storage/' . $dataperkembangan->foto2 ) }}" data-fancybox="jagung" data-caption="{{ $dataperkembangan->created_at }}"></a>
                <a href="{{ asset('storage/' . $dataperkembangan->foto3 ) }}" data-fancybox="jagung" data-caption="{{ $dataperkembangan->created_at }}"></a>
                @else
                <h4>
