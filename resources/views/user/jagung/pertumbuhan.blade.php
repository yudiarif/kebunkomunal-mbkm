<div class="col-sm-12 col-xl-6">
    <div class="bg-light rounded h-100 p-4">
                        ...
                        <div class="bg-light rounded d-flex justify-content-center p-4">
                            ...
                            <div class="ms-3" style="text-align: center;">
                                ...
                                <h2 class="mb-0" style="color: green;">
                                    @if (!optional($datajagung->last())->tinggi == NULL)
                                    {{ optional($datajagung->last())->tinggi }}
                    ...
                    <div class="bg-light rounded d-flex justify-content-center p-4">
                        ...
                        <div class="ms-3" style="text-align: center;">
                            ...
                            <h2 class="mb-0" style="color: red;">
                                @if (!optional($datajagung)->sum('kematian') == NULL)
                                {{ optional($datajagung)->sum('kematian') }}
        ...
        <div class="custom-progress mt-3">
            <div class="progress-bar progress-bar-0-25" style="width: 20%;" aria-valuenow="{{ optional($datajagung->last())->kehijauan }}" aria-valuemin="0" aria-valuemax="100">
                <div style="font-size: large;">{{ optional($datajagung->last())->kehijauan }}</div>
            </div>
        </div>
...
<script>
     ...
     var mingguJagung = @json($datajagung->pluck('tinggi')->toArray());
     var tinggiJagung = @json($datajagung->pluck('tinggi'));
     var kematianJagung = @json($datajagung->pluck('kematian'));
